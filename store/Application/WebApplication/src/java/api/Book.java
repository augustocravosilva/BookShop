...
public class Book {
    ...
    public String getBook(@PathParam("isbn") String isbn) {
        ...
        SimpleBook b = storeBean.getBook(isbn);
        String google = storeBean.getGoogleBookAsString(isbn);
        return "{\"bookshop\":{\"stock\":"+b.stock+"},\"google\":"+google+"}";
