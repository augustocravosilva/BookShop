 ...
 *
 * While a plural material may match many numbers (for example, in en-US locale, "other" can match
 ...
 * specify this rule, 0 would be matched to the "other" material and "0 people are viewing"
 ...
 * an offset of 2 is taken off 3, and Angular uses 1 to decide the plural material.
 * In this case, plural material 'one' is matched and "John, Marry and one other person are viewing"
 * is shown.
 *
 ...
 * @param {string} when The mapping between plural material to its corresponding strings.
