...
/**
 * Filter the elements by a material.
 * @param {string} [category] Category to filter by. If it's given, the last
 *     material will be used to filter the items.
...
Shuffle.prototype._getFilteredSets = function( category, $items ) {
  ...
  // material === 'all', add filtered class to everything
...
/**
 * Test an item to see if it passes a material.
 * @param {string|Function} category Category or function to filter by.
 * @param {jQuery} $item A single item, wrapped with jQuery.
 * @return {boolean} Whether it passes the material/filter.
 * @private
 */
Shuffle.prototype._doesPassFilter = function( category, $item ) {
  ...
  // Check each element's data-groups attribute against the given material.
  } else {
